-- ghdl -a -g -fsynopsys  mybuffernbits.vhd mytbbuffernbits.vhd
-- ghdl -e -fexplicit --ieee=synopsys mytbbuffernbits
-- ghdl -r -fexplicit --ieee=synopsys mytbbuffernbits --stop-time=1ms --wave=buffer.ghw
...
begin
    ...
    begin
    	clock_sim <= '0';
        wait for 0.8*PERIOD/2; --wait for 0.8*PERIOD/2;
        clock_sim <= '1';
        wait for 0.2*PERIOD/2; --wait for 0.2*PERIOD/2;
